...
$pdf->SetTitle('Downpayment Details',true);
...
$pdf->Cell(90,13,'Downpayment Details','','0','C');
...
if (isset($_GET["res-id"])) {
    ...
    $total=0; $child=0;$adult=0;
		...
		if ($query->num_rows > 0) {
			...
			$pdf->Cell(50,5,'Downpayment (Paid):','1','0','R');//'.$fetch3['payment_status'].'

			$pdf->Cell(50,5,number_format($downpayment,2),'1','0','R');
